...
<section class="panel"><div class="head"><div><span class="eyebrow">Cash-flow view</span><h2>Expected invoice payments by month</h2><p class="asof">Select one or more bars to filter the payment table.</p></div><div class="chartActions"><div class="legend"><span><i class="dot danger"></i>Past due</span><span><i class="dot today"></i>Due today</span><span><i class="dot future"></i>Future due</span></div><div class="selectionSummary" id="selectionSummary" hidden aria-live="polite"><span>Selected total</span><strong id="selectedTotal">$0.00</strong><small id="selectedMeta"></small></div><button type="button" class="clearGraph" id="clearGraph" hidden>Clear graph filters</button></div></div>
